...
class HtmlComponents {
	...
	public static function title_block( string $title, string $icon = null ) {
		echo '<div class="content__title">
                <span class="scd-color-primary"><i class="fa fa-bars"></i> ' . esc_html( $title ) . '</span>
            </div>
	...
	public static function checkbox( array $arg ) {
		echo '<div class="content__body  ' . esc_attr( $arg['field_value_parent'] ?? '' ) . ' ' . esc_attr( $arg['label_for_parent'] ?? '' ) . '">
                <div class="line">
                    ...
                    <div class="scd_tooltip">
                        <span class="scd_tooltiptext"></span>
                    </div>
                    <div class="scd-col-2">
	...
	public static function select( array $arg ) {
		echo '<div class="content__body ' . esc_attr( $arg['field_value_parent'] ?? '' ) . ' ' . esc_attr( $arg['label_for_parent'] ?? '' ) . '">
                ...
                <div class="scd_tooltip">
                    <span class="scd_tooltiptext">' . esc_html( $arg['help'] ?? '' ) . '</span>
                </div>
                <div class="scd-col-2 scd-form-control w-150" style="margin-left: 10px !important">
                    <select name="' . esc_attr( $arg['field_name'] ?? '' ) . '" class="scd-form-control w-100">
	...
	public static function multiple_select( array $arg ) {
		echo '<div class="content__body ' . esc_attr( $arg['field_value_parent'] ?? '' ) . ' ' . esc_attr( $arg['label_for_parent'] ?? '' ) . '">
				<div class="line">
                    ...
                    <div class="scd-col-2 scd-form-control" style="height:auto;">
                        <select class="scd-multiple-select form-component w-100" style="width:100" name="' . esc_html( $arg['field_name'] ?? '' ) . '[]" multiple="multiple">
                            ' . wp_kses( $arg['options'] ?? '', ( $arg['allowed_html'] ?? '' ) ) . '
                        </select>
                    </div>
				</div>
	...
	public static function input( array $arg ) {
		echo '<div class="content__body ' . esc_attr( $arg['field_value_parent'] ?? '' ) . ' ' . esc_attr( $arg['label_for_parent'] ?? '' ) . '">
				<div class="line">
                    ...
                    <div class="scd-col-2 scd-form-control" style="height:auto;">
                            <input class="scd-form-control" type="' . esc_html( $arg['input_type'] ?? '' ) . '" name="' . esc_html( $arg['field_name'] ?? '' ) . '" value="' . esc_html( $arg['field_value'] ?? '' ) . '" > 
                        </div>
				</div>
			</div>';
	}
	...
	public static function message_component( array $arg ) {
		echo '<div class="scd-divider"></div>
		<div class="content__body">
			<div class="line">
				<div class="col-sm-2">
					Enter your email :
				</div>
				<div class="scd-form-control w-100" style="height:auto;">
					<input class="scd-form-control w-100" type="email" placeholder="Enter an email address or we can easily chat thanks" name="' . esc_html( $arg['label_for'] ) . '" value="' . esc_html( $arg['current_user_email'] ?? '' ) . '" > 
				</div>
			</div>
			<hr>
			<div class="line">
	...
	public static function card( array $arg ) {
		echo '<div class="card col-sm-3 scd-form-control" style="height: 365px;">
          <img src="' . esc_url_raw( SCD_PLUGIN_ASSETS ) . '/img/plugin.png" class="card-img-top img-thumbnail" alt="...">
	...
	public static function manual_currency_options_row( $arg ):string {
		return '<div>
		<hr class="scd-my-5">
		<div class="scd_row align-items justify-content-between">
			<div class="scd-col-2 scd-form-control" style="margin-left: 10px !important">
				<button class="scd-bg-light border-0 delete-currency-option"><i class="fa fa-trash text-danger"></i></button>
			</div>
			<div class="scd-col-2 scd-form-control w-150" style="margin-left: 10px !important">
				<select class="scd-form-control w-150 currency-option-select form-component" data-old_value="' . esc_html( $arg['currency'] ) . '" data-label="currency" name="' . esc_html( $arg['field_name'] ) . '[' . esc_html( $arg['currency'] ) . '][currency]">
			...
			<div class="scd-col-1 scd-form-control w-150" style="margin-left: 10px !important">
				<input class="scd-form-control w-150 form-component" value="' . esc_html( $arg['rate'] ) . '" type="text" placeholder="rate" data-label="rate" name="' . esc_html( $arg['field_name'] ) . '[' . esc_html( $arg['currency'] ) . '][rate]">
			</div>
			<div class="scd-col-2 scd-form-control w-150" style="margin-left: 10px !important">
				<select class="scd-form-control w-150 form-component" data-label="increase" name="' . esc_html( $arg['field_name'] ) . '[' . esc_html( $arg['currency'] ) . '][increase]">
			...
			<div class="scd-col-2 scd-form-control w-150" style="margin-left: 10px !important">
				<input class="scd-form-control w-150 form-component"  value="' . esc_html( $arg['symbol'] ) . '" placeholder="symbol" type="text" data-label="symbol" name="' . esc_html( $arg['field_name'] ) . '[' . esc_html( $arg['currency'] ) . '][symbol]">
			</div>
			<div class="scd-col-2 scd-form-control w-150" style="margin-left: 10px !important">
				<select class="scd-form-control w-150 form-component" data-label="position" name="' . esc_html( $arg['field_name'] ) . '[' . esc_html( $arg['currency'] ) . '][position]">
